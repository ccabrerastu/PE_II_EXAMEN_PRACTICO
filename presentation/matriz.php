...
.button-container a:hover {
 ...
 <!-- Funcionalidad para generar Matriz BCG -->
            <!-- MATRIZ BCG -->
            <div class="card">
    <h4 class="header-bcg">📊 Matriz BCG</h4>
    <form method="POST">
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generarMatrizBCG'])): ?>
        ...
        <div class="bcg-matrix">
            ...
            <div class="bcg-cell">
                ...
                <?php foreach ($grupos['Estrella'] as $item): ?>
                    <p>🌟 <?php echo htmlspecialchars($item['nombre']); ?> (<?php echo $item['decision']; ?>)</p>
                <?php endforeach; ?>
            </div>
            ...
            <div class="bcg-cell">
                <h5>❓ Incógnitas</h5>
                <img src="https://media.giphy.com/media/l0IylOPCNkiqOgMyA/giphy.gif" alt="Incógnita">
                <?php foreach ($grupos['Incógnita'] as $item): ?>
                    <p>🤔 <?php echo htmlspecialchars($item['nombre']); ?> (<?php echo $item['decision']; ?>)</p>
                <?php endforeach; ?>
            </div>
        ...
        <div class="bcg-labels">
            <div>Crecimiento del mercado alto ↑</div>
            <div>Crecimiento del mercado bajo ↓</div>
        </div>
    <?php endif; ?>
</div>
        <?php endif; ?>
